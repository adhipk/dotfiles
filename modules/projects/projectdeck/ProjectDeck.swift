...
// man-me: usage=modules/projects/bin/projects pick (or projects pick when enabled)
// man-me: description=Dormant SwiftUI project picker built only by the manual make target.
