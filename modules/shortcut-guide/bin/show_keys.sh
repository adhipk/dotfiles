...
# man-me: description=Toggle the searchable skhd shortcut guide, rebuilding it from module source when needed.
...
module_dir="${SHORTCUT_GUIDE_MODULE_DIR:-$dotfiles_dir/modules/shortcut-guide}"
build_script="$module_dir/install/build-whichkey.sh"
source_file="$module_dir/app/WhichKey.swift"
action="${1:-toggle}"
