...
assert_contains "$TERMINAL_WINDOW_TYPES_TMUX" "set -gq allow-passthrough on" "Tmux permits visible-pane Awrit graphics passthrough"
...
assert_contains "$DOTFILES_DIR/home/.chezmoidata.toml" 'revision = "c692a737bfbfa8c647e03d0a1ab904247ce28ac5"' "Awrit bootstrap is pinned to the tested native tmux integration"
