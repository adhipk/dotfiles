...
do
  ...
  vim.keymap.set('n', '<leader>sh', function() builtin.find_files { hidden = true } end, { desc = '[S]earch [H]idden files' })
  vim.keymap.set('n', '<leader>sm', builtin.help_tags, { desc = '[S]earch [M]anual' })
